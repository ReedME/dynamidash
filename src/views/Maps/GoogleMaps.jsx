...
const SatelliteMap = withScriptjs(
  withGoogleMap(props => (
    <GoogleMap
      defaultZoom={3}
      mapTypeId={"satellite"}
      defaultCenter={{ lat: -28.0167, lng: 153.4000 }}
      defaultOptions={{
        scrollwheel: false
      }}
    >
      <Marker position={{ lat: -28.0167, lng: 153.4000 }} />
    </GoogleMap>
  ))
);
      ...
      <GridContainer>
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            ...
            <CardBody>
              <SatelliteMap
                googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyAc2sL8c5Jh588HZtKWSf60ztz7gJGiwxM"
