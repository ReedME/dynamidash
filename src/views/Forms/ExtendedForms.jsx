        ...
        <GridContainer>
          <GridItem xs={12} sm={12} md={12}>
            <Card>
             ...
             <div data-paperform-id="xw2pt7of"></div>{(function() {var script = document.createElement('script'); script.src = "https://paperform.co/__embed"; document.body.appendChild(script); })()}
